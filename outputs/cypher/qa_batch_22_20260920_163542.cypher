// ===============================================================================
// BATCH INGESTION: qa_batch_22_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_0050'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Công ty Trung Quốc đang',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Công ty Trung Quốc đang hoạt động tại Việt Nam có ký ',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_4058'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi cơ quan Thuế, ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi cơ quan Thuế, 1/ Công ty em đang có trường h',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_4380'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Hộ kinh doanh tôi có ki',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Hộ kinh doanh tôi có kinh doanh mặt hàng cám, đồng th',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_2113'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, tôi tên là Thẩm Thu Hà, sinh n',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_4011'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Tôi có thửa đất diện tí',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Tôi có thửa đất diện tích 150 m2 tại phường Hội Phú. ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_2372'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, theo quy định tại Khoản 6, Điề',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_3955'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính;',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính; Cục thuế Tôi công tác tại Cục',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_9952'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính :',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính : Tôi tên là Nguyễn Văn A, hiện',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_6716'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: - Theo quy định tại điể',
    qa_9.scenario_description = 'Tình huống thực tế: Title: - Theo quy định tại điểm a khoản 8 Điều 23 Nghị định ',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_2327'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Tôi xin được giải đá',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Tôi xin được giải đáp nội dung sau: tôi là người ',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_6088'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Đơn vị tôi là đơn vị sự nghiệp',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_2132'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính X',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính Xin giải đáp, tư vấn cho đơn vị',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_0140'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi: BỘ TÀI CHÍNH ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi: BỘ TÀI CHÍNH Công ty TNHH Du lịch One More ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_0660'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Chủ đề: Hỏi về việc xuấ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Chủ đề: Hỏi về việc xuất hóa đơn đối với hàng mẫu xuấ',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_2781'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính thư Bộ Tài Chính! ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính thư Bộ Tài Chính! Tôi đang là hộ kinh doanh cho ',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_2251'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kinh gửi Bộ tài chính, ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kinh gửi Bộ tài chính, Tôi có câu hỏi vướng mắc liên ',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_8215'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Hiện nay có nhiều doanh nghiệp',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_9373'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi là do',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi là doanh nghiệp do Nhà nước nắm giữ',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_6220'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: - Theo quy định tại kho',
    qa_19.scenario_description = 'Tình huống thực tế: Title: - Theo quy định tại khoản 4 Điều 10 Nghị quyết 198/20',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_3968'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Tôi có hồ sơ thục hiện ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Tôi có hồ sơ thục hiện thủ tục hoàn lại tiền sử dụng ',
