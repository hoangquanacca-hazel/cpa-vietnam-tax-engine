// ===============================================================================
// BATCH INGESTION: qa_batch_10_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_1615'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, Công ty tôi là đại lý bán hàng',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_2023'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Thủ tục đăng ký mua tem',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Thủ tục đăng ký mua tem điện tử rượu lần đầu theo mẫu',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_4491'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi: Cục Thuế - Bộ',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Cục Thuế - Bộ Tài chính Tôi là nhân viên nh',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_1246'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Theo Điều 218 Luật Đất ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Theo Điều 218 Luật Đất đai năm 2024 và Điều 99 Nghị đ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_4818'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính: ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính: Hiện nay thực hiện chính quyền',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_2818'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính. Kính gửi: Ban Chính sách Thuế',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_7285'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi: BỘ TÀI CHÍNH ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi: BỘ TÀI CHÍNH Hiện nay tôi đang hoạt động th',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_8881'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Tôi được thừa kế từ bố ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Tôi được thừa kế từ bố một thửa đất gồm 80 m² đất ở v',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_8628'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Theo thông báo số 1290/',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Theo thông báo số 1290/TB-QLG ngày 05/6/2026 của Cục ',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_8925'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Hiện tại tôi đang công tác tại',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_5746'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính thưa Quý Cơ quan, ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính thưa Quý Cơ quan, Vào ngày 23/04/2026, công ty c',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_5598'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Tôi tên là: Phạm Thị Án',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Tôi tên là: Phạm Thị Ánh Phượng, tôi có câu hỏi như s',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_9884'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: tôi nghỉ hưu tháng 3/20',
    qa_13.scenario_description = 'Tình huống thực tế: Title: tôi nghỉ hưu tháng 3/2026, tháng 4/2026 tôi sinh con.',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_8839'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính - Tên người nộp thuế: HUỲNH TH',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_8879'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Bố tôi là người hưởng c',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Bố tôi là người hưởng chính sách như thương binh, có ',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_4991'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính v',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính và Tổng cục thuế, Công ty chúng',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_6293'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Theo Nghị Định Nghị định số 70',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_6373'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Căn cứ Nghị định 254/20',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Căn cứ Nghị định 254/2026/NĐ-CP ban hành ngày 30/6/20',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_7512'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính. ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính. Công ty tôi sản xuất kinh doan',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_5692'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Căn cứ Mẫu số 3A ban hà',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Căn cứ Mẫu số 3A ban hành kèm theo Thông tư số 80/202',
