// ===============================================================================
// BATCH INGESTION: qa_batch_14_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_0881'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Về việc xác định thời đ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Về việc xác định thời điểm lập hóa đơn đối với khoản ',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_2004'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi: Tổng cụ Hải q',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Tổng cụ Hải quan. Công ty chúng tôi là công',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_4580'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính,',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính, Gia đình tôi có một thửa đất ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_2666'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính T',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính Tôi muốn hỏi về chính sách thuế',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_2407'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: 1.1 Cơ sở pháp lý: Theo',
    qa_5.scenario_description = 'Tình huống thực tế: Title: 1.1 Cơ sở pháp lý: Theo Thông tư 334/2016/TT-BTC quy ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_3531'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Tôi hiện là hộ kinh doa',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Tôi hiện là hộ kinh doanh hoạt động trong lĩnh vực lậ',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_4741'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Tôi là Giám đốc Công ty TNHH 2',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_4678'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bảo hiểm xã h',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bảo hiểm xã hội Việt Nam Hôm nay tôi và rất',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_4767'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bô Tài Chính.',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bô Tài Chính. Từ đầu năm 01/2026 đến hết th',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_1490'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính T',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính Thực hiện Nghị định số 32/2019/',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_1035'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Hiện tôi là người lao động làm',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_4280'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi Cơ quan Thuế, ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cơ quan Thuế, Công ty TNHH BIPO Việt Nam (MS',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_8808'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Công ty tôi là tổ chức ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Công ty tôi là tổ chức kinh tế có vốn đầu tư nước ngo',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_2775'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi xin t',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi xin trình bày và kính đề nghị Quý C',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_9230'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Điều 6. Tính tiền sử dụ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Điều 6. Tính tiền sử dụng đất đối với hộ gia đình, cá',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_4836'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính thưa quý Bộ, Theo ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính thưa quý Bộ, Theo quy định tại Điều 45 Nghị định',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_9604'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính Tôi là đại diện Hộ kinh doanh ',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_7625'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính T',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính Tôi có câu hỏi liên quan đến Th',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_6155'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Bộ Tài chính cho tôi hỏ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Bộ Tài chính cho tôi hỏi các nội dung sau: 1. Theo ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_4774'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gởi Bộ tài chính T',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gởi Bộ tài chính Tôi có vướng mắc về chính sách ',
