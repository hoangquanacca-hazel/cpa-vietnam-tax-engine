// ===============================================================================
// BATCH INGESTION: qa_batch_13_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_5698'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Hiện nay, tôi có tham g',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Hiện nay, tôi có tham gia hoạt động sáng tạo nội dung',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_7961'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính. Cha mẹ tôi được ông bà nội ch',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_7795'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính! ',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính! Bệnh viện đa khoa Bắc Kạn hiện',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_2442'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính;T',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính;Tôi là hộ kinh doanh có đăng ký',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_7485'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính v',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính và Cục Thuế Qui định tại điểm b',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_4841'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Hộ kinh doanh chúng tôi',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Hộ kinh doanh chúng tôi chuyên mua gia súc lợn, gà từ',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_3766'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Hiện tại, đơn vị chúng ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Hiện tại, đơn vị chúng tôi đang gặp vướng mắc về việc',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_3829'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính. Tôi là: Võ Quý Sơn - Tổng giá',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_1595'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính! ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính! Liên quan tới việc nộp thuế TN',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_4256'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: KÍnh gửi Bộ Tài Chính. ',
    qa_10.scenario_description = 'Tình huống thực tế: Title: KÍnh gửi Bộ Tài Chính. Tên tôi là Nguyễn Thị Liêm, đơ',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_9328'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: 1. Tại Nghị định số 73/',
    qa_11.scenario_description = 'Tình huống thực tế: Title: 1. Tại Nghị định số 73/2026/NĐ-CP ngày 10/3/2026 của ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_3471'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Theo quy định tại Điều ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Theo quy định tại Điều 4 Thông tư số 226/2016/TT-BTC,',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_8990'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, năm 2025 Bộ Tài chính thông bá',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_5492'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi kính ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi kính đề nghị Bộ Tài Chính hướng dẫn',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_1743'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Cơ quan Thuế, ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cơ quan Thuế, Công ty chúng tôi có phát sinh',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_1721'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ Tài Chính,',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ Tài Chính, việc nhà nước áp dụng giảm ti',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_2816'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ Tài Chính,',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ Tài Chính, tôi là người lao động chấm dứ',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_1514'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Tôi kính đề nghị Quý Bộ hướng ',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_1626'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Đề nghị Bộ Tài chính hướng dẫn',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_6010'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính,',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính, Đơn vị chúng tôi là đơn vị sự',
