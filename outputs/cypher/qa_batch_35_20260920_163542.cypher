// ===============================================================================
// BATCH INGESTION: qa_batch_35_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_7200'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Công ty chúng tôi hoạt động tr',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_1922'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi cơ quan Thuế ;',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi cơ quan Thuế ; Hiện nay hộ kinh doanh của ch',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_3181'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Công ty tôi có cán bộ l',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Công ty tôi có cán bộ làm việc tại công ty thành viên',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_4110'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Tôi có câu hỏi gửi đến ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Tôi có câu hỏi gửi đến Quý bộ như sau: Căn cứ Luật số',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_2054'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Câu 1: Năm 2022 Công ty',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Câu 1: Năm 2022 Công ty tôi thu mua tổ yến thô từ cá ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_6123'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính. Căn cứ Luật thuế TNDN số 67/2',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_6493'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Bố mẹ tôi đều là thương',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Bố mẹ tôi đều là thương binh: Bố hạng 2/4, mất sức 65',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_1938'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính. ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính. Đơn vị tôi là đơn vị sự nghiệp',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_3050'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính!',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính! Ngày 31/12/2025, Bộ Tài chính',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_3634'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính Tôi xin được hỏi về chính sách',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_6116'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Trong thời gian vừa qua',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Trong thời gian vừa qua, Công ty TNHH Cơ khí chính xá',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_7150'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi Quý Bộ! Tôi hi',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi Quý Bộ! Tôi hiện là kế toán kiêm nhiệm tại P',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_0411'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, Tôi có thắc mắc liên quan tới ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_8957'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Công ty tôi mỗi ngày bá',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Công ty tôi mỗi ngày bán khoảng 1.000 đơn hàng trên s',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_2104'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính g',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính giải đáp thêm về Thông tư số 14',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_6468'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Tôi xin được hỏi như sau: Theo',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_3816'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Tôi tên là Nguyễn Thị H',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Tôi tên là Nguyễn Thị Hường. Địa chỉ: Thôn 7, xã Đak ',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_2539'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Tôi xin được hỏi nội du',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Tôi xin được hỏi nội dung như sau: Tôi đang hạch toán',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_2474'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Cho tôi xin hỏi về cách',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Cho tôi xin hỏi về cách tính thuế thu nhập cá nhân kh',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_9684'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi quý Cơ quan. T',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi quý Cơ quan. Tôi làm cho tổ chức Khoa học cô',
