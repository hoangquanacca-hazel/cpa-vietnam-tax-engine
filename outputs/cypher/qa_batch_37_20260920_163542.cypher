// ===============================================================================
// BATCH INGESTION: qa_batch_37_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_4606'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Công ty TNHH Sản xuất v',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Công ty TNHH Sản xuất và Dịch vụ Gia Linh có MST 010',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_7341'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Điểm b khoản 3 Điều 50 ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Điểm b khoản 3 Điều 50 Nghị định số 103/2024/NĐ-CP dẫ',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_8862'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính,',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính, Theo như khoản 1,2,3 Điều 29 ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_0771'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi : Quý cơ quan ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi : Quý cơ quan Năm 2011 mẹ tôi nhận di sản th',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_6833'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Tôi muốn hỏi về những loại thu',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_5555'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi : Bộ Tài Chính',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi : Bộ Tài Chính Căn cứ theo nghị quyết 198/20',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_3552'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Hộ kinh doanh theo phươ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Hộ kinh doanh theo phương pháp kê khai từ 01/01/2026 ',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_8888'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi: CƠ QUAN THUẾ ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi: CƠ QUAN THUẾ CÓ THẨM QUYỀN CÔNG TY LUẬT TNH',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_9911'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi: Thuế cơ sở 8 ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Thuế cơ sở 8 Thành Phố Cần Thơ Tên Công ty:',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_4667'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi xin t',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi xin trình bày và kính hỏi Cơ quan T',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_3463'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Công ty của chúng tôi thành lậ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_2029'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Công ty Cổ phần Nước sạ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Công ty Cổ phần Nước sạch Hà Nam (sau đây gọi tắt là ',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_1842'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Gia đình tôi có thửa ao',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Gia đình tôi có thửa ao được giao từ năm 1955 và đã đ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_5553'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính Tôi là cá nhân hiện đang dự đị',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_4165'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Công ty chúng tôi là CÔNG TY T',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_3432'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Nghị định 347/2025/NĐ-CP ngày ',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_3034'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Tôi xin gửi ý kiến hỏi ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Tôi xin gửi ý kiến hỏi về một số vấn đề liên quan đến',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_6507'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi: THUẾ CƠ SỞ 3 ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi: THUẾ CƠ SỞ 3 TỈNH ĐỒNG NAI Công ty TNHH Tư ',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_2973'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Trong thời gian gần đây',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Trong thời gian gần đây, chính sách, pháp luật thuế c',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_5640'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi Cơ quan Thuế, ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cơ quan Thuế, Tôi tên là: Nguyễn Thị Việt Hà',
