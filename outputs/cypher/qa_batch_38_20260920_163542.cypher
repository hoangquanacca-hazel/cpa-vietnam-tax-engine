// ===============================================================================
// BATCH INGESTION: qa_batch_38_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_4878'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính Tôi đã có giấy phép hộ kinh do',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_3843'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Năm 2020, thửa đất của ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Năm 2020, thửa đất của gia đình tôi được tách thành 2',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_9513'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính (Tổng cục Thuế) Công ty chúng ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_0817'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Về thuế TNDN từ sáp nhập doanh',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_1178'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi: Ban Nghiệp vụ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Ban Nghiệp vụ Thuế Hải Quan – Cục Hải Quan ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_3893'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính nhờ Bộ Tài Chính h',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính nhờ Bộ Tài Chính hỗ trợ giúp tôi một số vướng mắ',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_5450'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Căn cứ Điểm c khoản 18 Điều 1 ',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_1696'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính thưa quý anh/chị. ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính thưa quý anh/chị. Tôi muốn hỏi về điểm a, khoản ',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_4801'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Căn cứ Nghị Định 320/2025/NĐ-C',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_7522'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ Tài Ch',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ Tài Chính. Cty TNHH ĐT TM và DV Đăng',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_4118'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Công ty TNHH Cảng & Log',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Công ty TNHH Cảng & Logistics Tân Chi - Mã số thuế: 2',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_3053'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Tôi là người đại diện t',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Tôi là người đại diện theo pháp luật của một công ty ',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_2050'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi: Cục Quản lý v',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Cục Quản lý và Giám sát bảo hiểm – Bộ tài c',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_3752'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính!',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính! Hiện nay, Công ty tôi đang mu',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_1279'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính T',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính Tại khoản 4 Điều 21 Nghị định 3',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_3117'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, ngoài lương cơ bản, tôi được n',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_2393'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi: Cục Phát triể',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Cục Phát triển Doanh nghiệp Tư nhân và Kinh',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_6035'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Hiện nay, doanh nghiệp ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Hiện nay, doanh nghiệp chúng tôi đang thực hiện thủ t',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_5332'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, Kính trình Quý cơ quan xem xét',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_1293'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Tôi chuyên viên phụ trá',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Tôi chuyên viên phụ trách quảng cáo của Sở VHTT Thành',
