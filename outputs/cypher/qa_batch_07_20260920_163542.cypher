// ===============================================================================
// BATCH INGESTION: qa_batch_07_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_7722'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, tôi có một số vấn đề vướng mắc',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_6656'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính chào Bộ Tài chính.',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính chào Bộ Tài chính. Đơn vị tôi là Quỹ Bảo vệ và p',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_6674'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Tôi tên TRẦN THÁI PHƯƠN',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Tôi tên TRẦN THÁI PHƯƠNG TRANG Xin phép gửi câu hỏi đ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_2084'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Khoản 1, Điều 10 Thông tư 91/2',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_2481'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Hộ kinh doanh chúng tôi',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Hộ kinh doanh chúng tôi bắt đầu hoạt động từ đầu năm ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_8705'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Công ty chúng tôi hoạt động tr',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_2588'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi BHXH Việt Nam,',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi BHXH Việt Nam, theo luật BHXH số 41 năm 2024',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_1737'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi cơ quan BHXH T',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi cơ quan BHXH Tôi tên là Lê Thị Xuân Mai, mã ',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_9188'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Công ty chúng tôi kính đề nghị',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_8466'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Trong quá trình điều hà',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Trong quá trình điều hành ngân sách địa phương, Ủy ba',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_9948'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Hiện tại e có nộp giấy ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Hiện tại e có nộp giấy ra viện con ốm lên công ty để ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_6467'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Hiện tại, đơn vị chúng tôi thự',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_7073'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Hiện nay trong Luật thu',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Hiện nay trong Luật thuế thu nhập doanh nghiệp, Nghị ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_7606'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Em có một câu hỏi liên quan đế',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_3148'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Theo Điểm b khoản 4 của Phụ lụ',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_4165'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính (V/v đề nghị hướng dẫn áp dụng',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_7920'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Điểm đ khoản 2 Điều 10 ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Điểm đ khoản 2 Điều 10 Luật Đấu thầu năm 2023 quy địn',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_7460'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính Đ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính Đơn vị chúng tôi là Trung tâm, ',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_3498'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Để có cơ sở thực hiện đúng quy',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_2524'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Theo quy định tại Điểm',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Theo quy định tại Điểm b khoản 2 Điều 1 Luật số ',
