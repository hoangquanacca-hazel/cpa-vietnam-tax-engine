// ===============================================================================
// BATCH INGESTION: qa_batch_33_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_7539'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Hiện nay, tôi đang thực',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Hiện nay, tôi đang thực hiện cung cấp dịch vụ bookkee',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_1570'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Nghị định 55/2026/NĐ-CP',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Nghị định 55/2026/NĐ-CP sửa đổi nghị định 63/2019/NĐ-',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_8806'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính h',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính hướng dẫn cụ thể về trường hợp ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_7976'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính: ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính: Hiện nay, Công ty chúng tôi đa',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_7537'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Tôi có một căn hộ cho t',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Tôi có một căn hộ cho thuê,tôi đã đăng ký và kê khai ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_1714'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Trong nghị định số 68/2',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Trong nghị định số 68/2026/NĐ-CP có quy định các chi ',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_6531'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Đầu năm 2026, công ty l',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Đầu năm 2026, công ty lựa chọn kê khai thuế thuê nhà ',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_0359'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính. Công ty chúng tôi sản xuất sả',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_5164'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, tôi muốn hỏi 1 vân đề về thuế ',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_3304'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kinh thưa quý Bộ Tại Ng',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kinh thưa quý Bộ Tại Nghị định 239/2025/NĐ-CP sửa đổi',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_9068'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi : Bộ Tài Chính',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi : Bộ Tài Chính! Kính nhờ Quý Cơ Quan, Quý An',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_1692'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính: ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính: - Căn cứ tại khoản 4 Điều 12 L',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_8136'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Xin đề nghị hướng dẫn v',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Xin đề nghị hướng dẫn và giải đáp thắc mặc: Thời điểm',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_6398'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Gia đình tôi mua nhà tạ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Gia đình tôi mua nhà tại Trung Liệt năm 1993. Sau đó,',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_4985'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Tại Khoản 5 Điều 8 Nghị',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Tại Khoản 5 Điều 8 Nghị định số 68/2026/NĐ-CP quy địn',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_8553'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi hoàn ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi hoàn thuế XKTC kỳ hoàn từ 07/2022 đ',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_3734'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Thuế Thành phố',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Thuế Thành phố Hồ Chí Minh, Tôi có nhận được',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_8298'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: CÔNG TY TNHH MTV FP VIÊ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: CÔNG TY TNHH MTV FP VIỆT NAM\ 57 Lê Thị Hồng Gấm,',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_3012'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Căn cứ điểm 2.30 khoản ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Căn cứ điểm 2.30 khoản 2 Điều 6 Thông tư 96 2015 TT-B',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_9146'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Tôi xin được hỏi như sau: Tôi ',
