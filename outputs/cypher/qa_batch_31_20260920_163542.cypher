// ===============================================================================
// BATCH INGESTION: qa_batch_31_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_4676'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ Tài chính,',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ Tài chính, Tôi xin phép được hỏi một nội',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_9151'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính. Tôi tên là Trần Thị Anh Thư, ',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_1541'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi quý Bộ, Đơn vị',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi quý Bộ, Đơn vị tôi là công ty BOT, tham gia ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_4990'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Cục quản lý và',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cục quản lý và giám sát bảo hiểm - Bộ Tài Ch',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_6961'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Ngày 10/02/2026 cục thu',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Ngày 10/02/2026 cục thuế có ban hành văn bản số 949/C',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_0846'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính Gửi Bộ Tài Chính: ',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính Gửi Bộ Tài Chính: Công ty chúng tôi là doanh ngh',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_3943'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Theo Điều 2, Nghị định ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Theo Điều 2, Nghị định 49/2025/NĐ-CP về quy định về n',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_2514'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, căn cứ khoản 1 Điều 9 Nghị địn',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_1348'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Theo hướng dẫn của văn ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Theo hướng dẫn của văn bản thuế hiện hành tại điểm c,',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_0617'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Theo quy định của Luật Ngân sá',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_2094'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Trong tháng 2/2026 công',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Trong tháng 2/2026 công ty chúng tôi có nhận được hóa',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_3999'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi là cô',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi là công ty 100% vốn đầu tư nước ngo',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_3142'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Tiêu đề: Vướng mắc về v',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Tiêu đề: Vướng mắc về việc xuất hóa đơn đối với khoản',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_4052'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Công ty chúng tôi hoạt động tr',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_8419'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Căn cứ Nghị định 320/20',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Căn cứ Nghị định 320/2025 ngày 15/12/2025 quy định và',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_0144'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, Khoản 3, Điều 18, NĐ 320/2025/',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_3477'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Trong quá trình triển k',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Trong quá trình triển khai thực hiện bảo hiểm bắt buộ',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_0181'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Chính sách ưu đãi thuế ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Chính sách ưu đãi thuế đối với điện năng lượng mặt tr',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_9306'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính: ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính: Công ty TNHH Chia Tải (Việt Na',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_8405'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Nội dung vướng mắc cần ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Nội dung vướng mắc cần hướng dẫn Công ty chúng tôi nh',
