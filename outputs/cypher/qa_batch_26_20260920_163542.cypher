// ===============================================================================
// BATCH INGESTION: qa_batch_26_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_0869'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ Tài Ch',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ Tài Chính Tôi tên Trịnh Thị Mộng Tuy',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_3667'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Căn cứ Nghị định số 108/2024/N',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_3576'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Đơn vị chúng tôi là đơn vị sự ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_0209'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Tổng Cục thuế!',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Tổng Cục thuế! Đơn vị chúng tôi có cung cấp ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_0209'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi Tổng Cục thuế!',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi Tổng Cục thuế! Đơn vị chúng tôi có cung cấp ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_3233'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Câu hỏi: Kính gửi Bộ Tà',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Câu hỏi: Kính gửi Bộ Tài Chính, Liên quan đến việc kê',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_7919'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Kính nhờ Quý cơ quan quan tâm ',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_0053'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Nhà máy sản xuất Dorco ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Nhà máy sản xuất Dorco Living Vina – số 2 gọi là dorc',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_9506'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ ta',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ tài chính Doanh nghiệp chúng',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_0164'})
ON CREATE SET 
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_8724'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi: - BỘ TÀI CHÍN',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi: - BỘ TÀI CHÍNH - CỔNG THÔNG TIN ĐIỆN TỬ BỘ ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_3867'})
ON CREATE SET 
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_7685'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính, ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính, Căn cứ vào thông tư 69/2025/TT',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_8367'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi Cơ Quan Thuế! ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cơ Quan Thuế! Từ năm 2017-2021 ông A có phát',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_2945'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Dự án khu tái định cư d',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Dự án khu tái định cư do doanh nghiệp làm chủ đầu tư ',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_4273'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ tài chính,',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ tài chính, cho tôi được hỏi theo Nghị đị',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_4352'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính C',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính Căn cứ điểm d.6, khoản 2, Điều ',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_3364'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: LÀM RÕ ĐỐI TƯỢNG ĐƯỢC G',
    qa_18.scenario_description = 'Tình huống thực tế: Title: LÀM RÕ ĐỐI TƯỢNG ĐƯỢC GIẢM TIỀN SỬ DỤNG ĐẤT KHI CHUYỂ',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_7369'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Tại Điều 21 Luật Phí và',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Tại Điều 21 Luật Phí và lệ phí quy định: “Thẩm quyền ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_5855'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi Quý Bộ! Tôi hi',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi Quý Bộ! Tôi hiện là kế toán tài sản tại đơn ',
