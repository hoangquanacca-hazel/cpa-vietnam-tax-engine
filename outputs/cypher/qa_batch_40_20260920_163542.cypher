// ===============================================================================
// BATCH INGESTION: qa_batch_40_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_9075'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Công ty tôi được Sở Kế ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Công ty tôi được Sở Kế Hoạch Đầu Tư Thành Phố Hồ Chí ',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_6453'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính,',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính, Tôi là đại diện Hộ kinh doanh',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_8534'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi cơ quan Thuế. ',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi cơ quan Thuế. Trong quá trình tìm hiểu chính',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_2627'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính.',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính. Công ty chúng tôi: CÔNG TY TN',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_2824'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Công ty là đơn vị quản ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Công ty là đơn vị quản lý, khai thác công trình thủy ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_4092'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi Quý Cơ quan, C',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi Quý Cơ quan, CÔNG TY TNHH MTV ĐẦU TƯ VÀ PHÁT',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_7433'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ tài chính ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ tài chính Kính nhờ Bộ tài chính xem và p',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_8039'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Công ty TNHH Kế toán và',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Công ty TNHH Kế toán và Tư vấn Thuế Trọng Tín (Trọng ',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_3615'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính,',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính, Tổng Cục Thuế Kính thưa Quý B',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_7664'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Căn cứ Nghị quyết 110/2',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Căn cứ Nghị quyết 110/2025/UBTVQH15 về việc điều chỉn',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_3639'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Đơn vị tôi được hợp nhấ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Đơn vị tôi được hợp nhất từ 02 đơn vị cũ, không có đơ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_2336'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Theo quyết định số 2507',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Theo quyết định số 2507/QĐ-BTC ngày 17/7/2025 của Bộ ',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_9709'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Theo quy định tại điểm d khoản',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_7633'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chinh! ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chinh! Nhà cung cấp của Công ty chúng',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_7656'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, căn cứ khoản 1 Điều 9 Nghị địn',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_1738'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ tài chính,',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ tài chính, Năm 2011 tôi được tuyển dụng ',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_9394'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính: ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính: Đơn vị tôi là trường Tiểu học ',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_9884'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính, ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính, tôi tên là Nguyễn Văn Hùng, tô',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_0498'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Căn cứ quy định tại kho',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Căn cứ quy định tại khoản 2 và khoản 24 Điều 4 Luật Đ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_1748'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Bên tôi năm 2025 đã thự',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Bên tôi năm 2025 đã thực hiện đặt hàng dịch vụ sự ngh',
