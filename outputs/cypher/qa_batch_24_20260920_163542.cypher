// ===============================================================================
// BATCH INGESTION: qa_batch_24_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_0686'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Hỏi về phương pháp tính',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Hỏi về phương pháp tính thuế TNCN đối với Hộ kinh doa',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_7444'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Gia đình tôi đang sử dụ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Gia đình tôi đang sử dụng hợp pháp một thửa đất ở như',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_1107'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ tài ch',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ tài chính. Kính mong BTC hướng dẫn D',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_9189'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính V/v: Đề nghị hướng dẫn xác địn',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_4169'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Theo điểm c khoản 2 Điề',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Theo điểm c khoản 2 Điều 10 Nghị quyết 254/2025/QH15,',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_6839'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Tôi đang gặp vướng mắc trong q',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_3802'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Gia đình tôi đã hoàn th',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Gia đình tôi đã hoàn thành hồ sơ chuyển mục đích sử d',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_8235'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi Cục Thuế , côn',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cục Thuế , công ty tôi trong năm 2025 có doa',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_8101'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Đề nghị được hỏi trường',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Đề nghị được hỏi trường hợp miễn giảm tiền sử dụng đấ',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_2591'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Theo quy định tại điểm ',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Theo quy định tại điểm c khoản 2 Điều 10 Nghị quyết s',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_8318'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi Cục Hải Quan C',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cục Hải Quan Công ty tôi là CÔNG TY CỔ PHẦN ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_2835'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính; ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính; Tôi tên Phạm Văn Hải nguyên cô',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_7196'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Cuối năm 2025, vợ chồng',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Cuối năm 2025, vợ chồng tôi được bố mẹ tặng cho 398m²',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_2596'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi cơ quan thuế: ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi cơ quan thuế: Theo Khoản 3 Điều 71 Luật số 9',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_1784'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính. ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính. Bệnh viện là đơn vị sự nghiệp,',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_7527'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính!',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính! - Tên doanh nghiệp: CÔNG TY C',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_2951'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Theo quy định pháp luật',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Theo quy định pháp luật thuế GTGT áp dụng từ ngày 01/',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_4314'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Theo quy định tại điểm ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Theo quy định tại điểm h khoản 9 Điều 31 Luật số 89/2',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_8206'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Trong quá trình hoạt độ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Trong quá trình hoạt động, chúng tôi phát sinh vướng ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_5728'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Tôi có vài câu hỏi liên quan đ',
