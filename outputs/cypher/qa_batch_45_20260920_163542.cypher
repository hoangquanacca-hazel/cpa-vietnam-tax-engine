// ===============================================================================
// BATCH INGESTION: qa_batch_45_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_0813'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi bộ Tài Chính: ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi bộ Tài Chính: Theo khoản 8, điều 4 Thu nhập ',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_4479'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Xin chào! DN hoạt động ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Xin chào! DN hoạt động ở lĩnh vực xây dựng, tôi muốn ',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_2329'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Khi thực hiện luật thuế',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Khi thực hiện luật thuế thu nhập cá nhân số 109/2025/',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_6590'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ Tài chính ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ Tài chính và Tổng Cục Thuế! Tôi tên là Đ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_5295'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: NĐ số 320/2025/NĐ-CP ng',
    qa_5.scenario_description = 'Tình huống thực tế: Title: NĐ số 320/2025/NĐ-CP ngày 15/12/2025, tại điểm c, kho',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_8190'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính,',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính, Tôi tên là Nguyễn Minh Nam, h',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_0484'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi: Cục Quản lý g',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Cục Quản lý giá - Bộ Tài chính. Theo Thông ',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_8879'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Tôi là kế toán của trường THPT',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_1380'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Điểm đ khoản 1 Điều 20 ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Điểm đ khoản 1 Điều 20 Nghị định 214/2025/NĐ-CP quy đ',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_2193'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi BTC Tôi mua hà',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi BTC Tôi mua hàng hóa, dịch vụ với các hóa đơ',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_0573'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính, ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính, tôi xin phép được hỏi một số n',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_1765'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Liên quan đến câu hỏi “',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Liên quan đến câu hỏi “Có áp dụng luật mới để sửa hợp',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_3722'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Dự án hạ tầng kỹ thuật ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Dự án hạ tầng kỹ thuật và hạ tầng xã hội khu đô thị đ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_1525'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Tôi công tác tại Sở Xây',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Tôi công tác tại Sở Xây dựng, đang xử lý dự án khu nh',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_3397'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Đơn vị chúng tôi là doa',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Đơn vị chúng tôi là doanh nghiệp 100% vốn tư nhân, đư',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_0659'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Tại điểm d khoản 2 Điều',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Tại điểm d khoản 2 Điều 18 Nghị định 214/2025/NĐ-CP q',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_0668'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Tôi đang công tác tại Ban Quản',
