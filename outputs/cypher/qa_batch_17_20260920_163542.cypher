// ===============================================================================
// BATCH INGESTION: qa_batch_17_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_1235'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Hiện nay tôi đang công tác tại',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_5307'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính! ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính! Công ty chúng tôi kinh doanh v',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_0296'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Tôi có vướng mắc về việc xác đ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_0488'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính: ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính: Tôi có câu hỏi xin hỏi bộ giải',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_2203'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Tôi là hộ kinh doanh, đã được ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_6500'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Tôi xin trình bày thông',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Tôi xin trình bày thông tin thửa đất như sau: Thửa đấ',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_2266'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Vừa qua CÔNG TY có ủy quyền ch',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_1215'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Liên quan đến quy định các trư',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_5210'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Theo điểm b.2 khoản 3 Điều 7 N',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_1746'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chínhC',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chínhCông ty Kiểm toán chúng tôi đan',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_4591'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính 1. Thông tin về Công ty và kho',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_9616'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kinh thưa Bộ tài chính,',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kinh thưa Bộ tài chính, đơn vị sự nghiệp công lập (nh',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_8930'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Đơn vị tôi là đơn vị sự nghiệp',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_1128'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Hiện tại quy định về gi',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Hiện tại quy định về giám sát đầu tư đang có 2 văn bả',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_9071'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Theo nghị định số 32/20',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Theo nghị định số 32/2019 NĐ-CP ngày 10 tháng 4 năm 2',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_2828'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính. Tôi đang công tác tại Ban quả',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_0949'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Công ty chúng tôi là doanh ngh',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_9956'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Tôi đang công tác tại đơn vị n',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_3680'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Tôi đang công tác tại đơn vị n',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_9333'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi: TỔNG CỤC HẢI ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi: TỔNG CỤC HẢI QUAN Tên doanh nghiệp: Công ty',
