// ===============================================================================
// BATCH INGESTION: dispatches_batch_07_20260920_163542
...
MERGE (disp_1:OFFICIAL_DISPATCH {id: 'DISPATCH_4849'})
ON CREATE SET 
    ...
    disp_1.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6227/CT-QLNT Tiêu đề: None Cơ quan: None Ngày: None...',
    disp_1.legal_status = 'Active';



MERGE (disp_2:OFFICIAL_DISPATCH {id: 'DISPATCH_8321'})
ON CREATE SET 
    ...
    disp_2.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6304/CT-QLNT Tiêu đề: None Cơ quan: None Ngày: None...',
    disp_2.legal_status = 'Active';



MERGE (disp_3:OFFICIAL_DISPATCH {id: 'DISPATCH_1038'})
ON CREATE SET 
    ...
    disp_3.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6325/CT-QLNT Tiêu đề: V/v höa don Cơ quan: Chính ph...',
    disp_3.legal_status = 'Active';



MERGE (disp_4:OFFICIAL_DISPATCH {id: 'DISPATCH_7624'})
ON CREATE SET 
    ...
    disp_4.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6335/CT-QLNT Tiêu đề: V/v chính sách thuế giá trị g...',
    disp_4.legal_status = 'Active';



MERGE (disp_5:OFFICIAL_DISPATCH {id: 'DISPATCH_3824'})
ON CREATE SET 
    ...
    disp_5.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6341/CT-QLNT Tiêu đề: V/v chính sách hóa đơn Cơ qua...',
    disp_5.legal_status = 'Active';



MERGE (disp_6:OFFICIAL_DISPATCH {id: 'DISPATCH_2309'})
ON CREATE SET 
    ...
    disp_6.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6479/CT-QLNT Tiêu đề: None Cơ quan: None Ngày: None...',
    disp_6.legal_status = 'Active';



MERGE (disp_7:OFFICIAL_DISPATCH {id: 'DISPATCH_5191'})
ON CREATE SET 
    ...
    disp_7.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6480/CT-QLNT Tiêu đề: None Cơ quan: None Ngày: None...',
    disp_7.legal_status = 'Active';



MERGE (disp_8:OFFICIAL_DISPATCH {id: 'DISPATCH_5342'})
ON CREATE SET 
    ...
    disp_8.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6486/CT-QLNT Tiêu đề: V/v chính sách thuế Hà Nội, n...',
    disp_8.legal_status = 'Active';



MERGE (disp_9:OFFICIAL_DISPATCH {id: 'DISPATCH_6501'})
ON CREATE SET 
    ...
    disp_9.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6487/CT-QLNT Tiêu đề: V/v trả lời vướng mắc của doa...',
    disp_9.legal_status = 'Active';



MERGE (disp_10:OFFICIAL_DISPATCH {id: 'DISPATCH_5365'})
ON CREATE SET 
    ...
    disp_10.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6643/CT-QLNT Tiêu đề: V/v chính sách thuế GTGT Cơ q...',
    disp_10.legal_status = 'Active';



MERGE (disp_11:OFFICIAL_DISPATCH {id: 'DISPATCH_5611'})
ON CREATE SET 
    ...
    disp_11.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6645/CT-QLNT Tiêu đề: None Cơ quan: None Ngày: None...',
    disp_11.legal_status = 'Active';



MERGE (disp_12:OFFICIAL_DISPATCH {id: 'DISPATCH_2961'})
ON CREATE SET 
    ...
    disp_12.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6654/CT-QLNT Tiêu đề: V/v chính sách tiền thuê đất ...',
    disp_12.legal_status = 'Active';



MERGE (disp_13:OFFICIAL_DISPATCH {id: 'DISPATCH_4103'})
ON CREATE SET 
    ...
    disp_13.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6661/CT-QLNT Tiêu đề: V/v thuế giá trị gia tăng Cơ ...',
    disp_13.legal_status = 'Active';



MERGE (disp_14:OFFICIAL_DISPATCH {id: 'DISPATCH_6935'})
ON CREATE SET 
    ...
    disp_14.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6687/CT-QLNT Tiêu đề: V/v ké khai thué GTGT Cơ quan...',
    disp_14.legal_status = 'Active';



MERGE (disp_15:OFFICIAL_DISPATCH {id: 'DISPATCH_2137'})
ON CREATE SET 
    ...
    disp_15.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6689/CT-QLNT Tiêu đề: V/v tiền sử dụng đất, tiền th...',
    disp_15.legal_status = 'Active';



MERGE (disp_16:OFFICIAL_DISPATCH {id: 'DISPATCH_8602'})
ON CREATE SET 
    ...
    disp_16.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 22/2026/NQ-CP Tiêu đề: None Cơ quan: Chính phủ Ngày...',
    disp_16.legal_status = 'Active';



MERGE (disp_17:OFFICIAL_DISPATCH {id: 'DISPATCH_9132'})
ON CREATE SET 
    ...
    disp_17.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6755/CT-QLNT Tiêu đề: None Cơ quan: None Ngày: None...',
    disp_17.legal_status = 'Active';



MERGE (disp_18:OFFICIAL_DISPATCH {id: 'DISPATCH_0003'})
ON CREATE SET 
    ...
    disp_18.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6762 Tiêu đề: V/v trả lời phản ánh kiến nghị độc gi...',
    disp_18.legal_status = 'Active';



MERGE (disp_19:OFFICIAL_DISPATCH {id: 'DISPATCH_9332'})
ON CREATE SET 
    ...
    disp_19.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6810 Tiêu đề: V/v huö•ng dän vé ty giå trén h6a don...',
    disp_19.legal_status = 'Active';



MERGE (disp_20:OFFICIAL_DISPATCH {id: 'DISPATCH_8263'})
ON CREATE SET 
    ...
    disp_20.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 6845/CT-QLNT Tiêu đề: V/v hóa đơn Cơ quan: Chính ph...',
