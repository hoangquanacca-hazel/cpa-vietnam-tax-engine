// ===============================================================================
// BATCH INGESTION: qa_batch_44_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_1606'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính,',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính, Doanh nghiệp của chúng tôi th',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_7809'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Căn cứ Nghị định 320/20',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Căn cứ Nghị định 320/2025 ngày 15/12/2025 quy định và',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_9292'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi Cơ quan Thuế! ',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cơ quan Thuế! Đơn vị tôi là Ban quản lý dự á',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_8666'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Điểm b khoản 2 Điều 1 N',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Điểm b khoản 2 Điều 1 Nghị định số 111/2025/NĐ-CP ngà',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_7502'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi BTC, tôi có câ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi BTC, tôi có câu hỏi liên quan tới NĐ 359/202',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_4954'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi BTC, hộ tôi đa',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi BTC, hộ tôi đang kinh doanh karaoke thuộc nh',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_9098'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài Chính T',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài Chính Tôi có câu hỏi liên quan đến th',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_6706'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Tôi là Kế toán trường T',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Tôi là Kế toán trường Tiểu học, muốn hỏi là theo Nghị',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_4604'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Theo quy định tại Nghị ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Theo quy định tại Nghị định số 230/2025/NĐ-CP, trường',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_5014'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Hiện nay, cơ quan nơi t',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Hiện nay, cơ quan nơi tôi công tác yêu cầu rà soát, k',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_1371'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi BTC Theo Số: 3',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi BTC Theo Số: 320/2025/NĐ-CP QUY ĐỊNH CHI TIẾ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_4747'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính: ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính: Tôi là hộ kinh doanh thuộc diệ',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_8972'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Tôi hiện đang mở nhóm t',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Tôi hiện đang mở nhóm trẻ, lớp mầm non tư thục. Trước',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_8509'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Trước đây tôi có mua mộ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Trước đây tôi có mua một khoản nợ khó đòi từ ngân hàn',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_4917'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Xin hỏi: Theo quy định ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Xin hỏi: Theo quy định tại Nghị định 250/2025/NĐ-CP n',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_2874'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính Tôi tên là: Phạm Lương Ngọc Nh',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_9519'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính- ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính- Kính gửi Cục Thuế Tôi tên Nguy',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_2892'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính C',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính Công ty TNHH Friendship Sài Gòn',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_9451'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Đề nghị Bộ Tài chính gi',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Đề nghị Bộ Tài chính giúp tôi biết nội dung vụ việc n',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_5508'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Gia đình chúng tôi có đ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Gia đình chúng tôi có đăng ký hộ kinh doanh và được c',
