// ===============================================================================
// BATCH INGESTION: qa_batch_12_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_6153'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi quý cơ quan, t',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi quý cơ quan, thay mặt doanh nghiệp tôi có mộ',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_5101'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Căn cứ khoản 6, điều 32',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Căn cứ khoản 6, điều 32, nghị định số 45/2026/NĐ-CP n',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_4587'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính t',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính tôi muốn hỏi về chính sách thuế',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_3454'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Trung tâm ngoại ngữ đượ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Trung tâm ngoại ngữ được Sở Giáo Dục và Đào Tạo cấp p',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_0424'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Xin hỏi tại khoản 5, đi',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Xin hỏi tại khoản 5, điều 145, nghị định số 214/2025/',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_2272'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính.',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính. Ngày 05/05/2026 Bộ Tài Chính ',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_7994'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Ban Quản lý dự án xã Hư',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Ban Quản lý dự án xã Hưng Hội tỉnh Cà Mau được Ủy ban',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_6731'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Kính thưa Quý Bộ, tôi có một c',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_7222'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi Quý Cơ quan, T',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi Quý Cơ quan, Tên Hợp tác xã: Hợp tác xã Nam ',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_1079'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Tôi xin kính đề nghị Bộ Tài ch',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_8249'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Công ty tôi có mã số',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Công ty tôi có mã số thuế: 0101873635, tại Khu đ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_7441'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính Về việc: Đề nghị hướng dẫn điề',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_0418'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi Tổng cục Thuế,',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi Tổng cục Thuế, Điều 26 Nghị định 253/2026/NĐ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_2255'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Vướng mắc về quy đổ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Vướng mắc về quy đổi doanh thu tính thuế đối v',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_2291'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, tôi muốn hỏi về thủ tục đề ngh',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_0638'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Công ty chế biến xuất k',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Công ty chế biến xuất khẩu gạo có dự án đầu tư nhà má',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_9066'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Công ty chúng tôi hoạt động tr',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_7895'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Hỏi: Kinh thưa bộ Tài C',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kinh thưa bộ Tài Chính, khi nhà hàng tôi khi phụ',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_1469'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Theo quy định tại mục b',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Theo quy định tại mục b.2 điểm b khoản 3 Điều 7 Nghị ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_0306'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Về việc: Hướng dẫn quy định "l',
