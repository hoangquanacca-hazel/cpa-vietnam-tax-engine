// ===============================================================================
// BATCH INGESTION: qa_batch_20_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_7462'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính. ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính. Theo quy định tại điểm g, Điều',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_6808'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Theo quy định điểm c, k',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Theo quy định điểm c, khoản 1, Điều 4 của Thông tư số',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_3848'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi Quý Bộ! Tôi hi',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi Quý Bộ! Tôi hiện là kế toán đơn vị sự nghiệp',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_8510'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính.',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính. Tôi đang công tác tại Phòng K',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_2575'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Cho tôi hỏi Bộ liên quan đến v',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_4005'})
ON CREATE SET 
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_2603'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Theo quy định tại điểm ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Theo quy định tại điểm C, khoản 5, điều 4 Thông tư 87',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_4535'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Công ty chúng tôi hiện đang th',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_5028'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gủi Bộ Tài chính, ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gủi Bộ Tài chính, tôi có câu hỏi muốn được giải ',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_4414'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính thưa BTC, tại Khoả',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính thưa BTC, tại Khoản 4.1 Công văn 6196/BTC-QLKT h',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_9894'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Hỏi về cách kê khai thu',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Hỏi về cách kê khai thuế của Hộ kinh doanh: + Hộ kinh',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_0115'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Hiện nay theo Nghị định',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Hiện nay theo Nghị định 154/2025/NĐ-CP về tinh giản b',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_4064'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Hiện tại tôi có nhập kh',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Hiện tại tôi có nhập khẩu 1 lô hàng đã đăng ký tờ kha',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_1516'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi: - CỤC HẢI QUA',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi: - CỤC HẢI QUAN - CỤC THUẾ - CỤC CÔNG NGHỆ T',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_6240'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi có ph',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi có phát sinh hợp đồng thuê nhà nguy',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_8852'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Tôi xin hướng dẫn xử lý',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Tôi xin hướng dẫn xử lý hồ sơ kê khai như nào để khôn',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_2626'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ Tài Ch',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ Tài Chính. Cho em hỏi mức giảm thuế ',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_0724'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Tôi tên Nguyễn Trung Ki',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Tôi tên Nguyễn Trung Kiên, trước đây là chuyên viên c',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_5486'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính H',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính Hiện nay tôi đang gặp vướng mắc',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_9646'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, tôi có vướng mắc xin được giải',
