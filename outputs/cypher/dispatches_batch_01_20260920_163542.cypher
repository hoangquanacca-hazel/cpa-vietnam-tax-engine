// ===============================================================================
// BATCH INGESTION: dispatches_batch_01_20260920_163542
...
MERGE (disp_1:OFFICIAL_DISPATCH {id: 'DISPATCH_9612'})
ON CREATE SET 
...
MERGE (disp_2:OFFICIAL_DISPATCH {id: 'DISPATCH_5806'})
ON CREATE SET 
...
MERGE (disp_3:OFFICIAL_DISPATCH {id: 'DISPATCH_3241'})
ON CREATE SET 
...
MERGE (disp_4:OFFICIAL_DISPATCH {id: 'DISPATCH_9178'})
ON CREATE SET 
...
MERGE (disp_5:OFFICIAL_DISPATCH {id: 'DISPATCH_0536'})
ON CREATE SET 
...
MERGE (disp_6:OFFICIAL_DISPATCH {id: 'DISPATCH_4456'})
ON CREATE SET 
    ...
    disp_6.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 001/CV-JV Tiêu đề: None Cơ quan: None Ngày: None Fi...',
    disp_6.legal_status = 'Active';



MERGE (disp_7:OFFICIAL_DISPATCH {id: 'DISPATCH_7127'})
ON CREATE SET 
    ...
    disp_7.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 2015/NĐ-CP Tiêu đề: None Cơ quan: None Ngày: None F...',
    disp_7.legal_status = 'Active';



MERGE (disp_8:OFFICIAL_DISPATCH {id: 'DISPATCH_3067'})
ON CREATE SET 
    ...
    disp_8.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: None Tiêu đề: None Cơ quan: None Ngày: None File gố...',
    disp_8.legal_status = 'Active';



MERGE (disp_9:OFFICIAL_DISPATCH {id: 'DISPATCH_6864'})
ON CREATE SET 
    ...
    disp_9.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 2025/NĐ-CP Tiêu đề: None Cơ quan: None Ngày: None F...',
    disp_9.legal_status = 'Active';



MERGE (disp_10:OFFICIAL_DISPATCH {id: 'DISPATCH_4845'})
ON CREATE SET 
    ...
    disp_10.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 1011/QĐ-CT Tiêu đề: None Cơ quan: Cục Thuế Ngày: No...',
    disp_10.legal_status = 'Active';



MERGE (disp_11:OFFICIAL_DISPATCH {id: 'DISPATCH_1593'})
ON CREATE SET 
    ...
    disp_11.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 2025/NĐ-CP Tiêu đề: None Cơ quan: None Ngày: None F...',
    disp_11.legal_status = 'Active';



MERGE (disp_12:OFFICIAL_DISPATCH {id: 'DISPATCH_9799'})
ON CREATE SET 
    ...
    disp_12.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 2025/QHL Tiêu đề: None Cơ quan: None Ngày: None Fil...',
    disp_12.legal_status = 'Active';



MERGE (disp_13:OFFICIAL_DISPATCH {id: 'DISPATCH_2511'})
ON CREATE SET 
    ...
    disp_13.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 2025/NĐ-CP Tiêu đề: None Cơ quan: None Ngày: None F...',
    disp_13.legal_status = 'Active';



MERGE (disp_14:OFFICIAL_DISPATCH {id: 'DISPATCH_6958'})
ON CREATE SET 
    ...
    disp_14.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 2026/ND Tiêu đề: None Cơ quan: None Ngày: None File...',
    disp_14.legal_status = 'Active';



MERGE (disp_15:OFFICIAL_DISPATCH {id: 'DISPATCH_5899'})
ON CREATE SET 
    ...
    disp_15.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: None Tiêu đề: None Cơ quan: None Ngày: None File gố...',
    disp_15.legal_status = 'Active';



MERGE (disp_16:OFFICIAL_DISPATCH {id: 'DISPATCH_7653'})
ON CREATE SET 
    ...
    disp_16.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 2025/NĐ-CP Tiêu đề: None Cơ quan: None Ngày: None F...',
    disp_16.legal_status = 'Active';



MERGE (disp_17:OFFICIAL_DISPATCH {id: 'DISPATCH_5887'})
ON CREATE SET 
    ...
    disp_17.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: None Tiêu đề: None Cơ quan: None Ngày: None File gố...',
    disp_17.legal_status = 'Active';



MERGE (disp_18:OFFICIAL_DISPATCH {id: 'DISPATCH_6971'})
ON CREATE SET 
    ...
    disp_18.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 2026/NĐ-CP Tiêu đề: None Cơ quan: None Ngày: None F...',
    disp_18.legal_status = 'Active';



MERGE (disp_19:OFFICIAL_DISPATCH {id: 'DISPATCH_0642'})
ON CREATE SET 
    ...
    disp_19.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 13/NQ-CP Tiêu đề: None Cơ quan: None Ngày: None Fil...',
    disp_19.legal_status = 'Active';



MERGE (disp_20:OFFICIAL_DISPATCH {id: 'DISPATCH_5007'})
ON CREATE SET 
    ...
    disp_20.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 2026/NĐ-CP Tiêu đề: None Cơ quan: None Ngày: None F...',
