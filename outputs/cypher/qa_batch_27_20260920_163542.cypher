// ===============================================================================
// BATCH INGESTION: qa_batch_27_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_3502'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính. ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính. Tôi có câu hỏi vướng mắc xin đ',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_2661'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính chào Bộ Tài chính.',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính chào Bộ Tài chính. Hiện tại bên em đang nhập khẩ',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_7518'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Gia đình tôi đăng ký ho',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Gia đình tôi đăng ký hoạt động theo hình thức hộ kinh',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_4550'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Tôi là Ngô Văn Hải (Năm',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Tôi là Ngô Văn Hải (Năm sinh: 1971). Tôi có thửa đất ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_7034'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi Cục thuế Công ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cục thuế Công ty chúng tôi phát sinh chi trả',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_1974'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Xin hỏi BTC: Chồng tôi ',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Xin hỏi BTC: Chồng tôi là chủ hộ kinh doanh hoạt động',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_3414'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Căn cứ điểm đ, e khoản ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Căn cứ điểm đ, e khoản 3 Điều 8 Nghị định số 68/2026/',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_6720'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Tôi sử dụng mẫu 07/XN-N',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Tôi sử dụng mẫu 07/XN-NPT-TNCN ban hành kèm theo Thôn',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_3355'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Điểm c và điểm d Khoản ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Điểm c và điểm d Khoản 3 Điều 7 Nghị định số 346/2025',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_7295'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Hộ kinh doanh của gia đ',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Hộ kinh doanh của gia đình tôi có doanh thu dưới 500 ',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_4642'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Tôi hiện công tác tại T',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Tôi hiện công tác tại Trường Đại học Y Hà Nội. Khoảng',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_0638'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Ngày 14/01/2026, Chính phủ đã ',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_3613'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Hiện hộ kinh doanh của ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Hiện hộ kinh doanh của tôi đang hoạt động kinh doanh ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_2098'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Hỏi: Căn cứ điểm c khoả',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Hỏi: Căn cứ điểm c khoản 18 Điều 1 Nghị định 291/2025',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_4287'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Cổng Thông Tin',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cổng Thông Tin Điện Tử Bộ Tài Chính Tên doan',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_7748'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ Tài Chính,',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ Tài Chính, theo quy định của Điều 4 Thôn',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_3608'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính Hiện nay, có nhiều gói thầu E-',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_7980'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Theo mẫu 6A hồ sơ mời t',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Theo mẫu 6A hồ sơ mời thầu dịch vụ tư vấn qua mạng ba',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_2442'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính;',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính; (Nội dung hỏi: V/v: Vướng mắc',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_9066'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Chủ đề: Vướng mắc về vi',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Chủ đề: Vướng mắc về việc đề xuất thay thế nhân sự ch',
