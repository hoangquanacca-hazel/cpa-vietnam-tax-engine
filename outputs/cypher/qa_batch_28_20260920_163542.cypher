// ===============================================================================
// BATCH INGESTION: qa_batch_28_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_1595'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính G',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính Gói thầu tư vấn được thực hiện ',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_9489'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Việc xác nhận người phụ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Việc xác nhận người phụ thuộc khi tính thuế thu nhập ',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_7823'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Theo Công văn số 218/CS',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Theo Công văn số 218/CST-TN ngày 27/01/2026 của Cục Q',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_9238'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: xin phép hỏi: Gói thầu ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: xin phép hỏi: Gói thầu tư vấn lập quy hoạch chung đô ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_7025'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Điểm b khoản 1 Điều 126',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Điểm b khoản 1 Điều 126 Luật Đất đai quy định: “Điều ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_9852'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: 1. Trường hợp dịch vụ h',
    qa_6.scenario_description = 'Tình huống thực tế: Title: 1. Trường hợp dịch vụ hoàn thành vào ban đêm, ngày ng',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_6966'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Ngày 01/3/2026 Luật Quy hoạch ',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_8470'})
ON CREATE SET 
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_8918'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Trong quá trình triển k',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Trong quá trình triển khai quy hoạch đô thị và nông t',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_7406'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Nhà thầu xin được làm r',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Nhà thầu xin được làm rõ một số nội dung về tờ khai h',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_1886'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính, ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính, Tôi xin có nội dung cần hỏi và',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_3797'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Năm 2017, gia đình tôi ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Năm 2017, gia đình tôi có mua 1 lô đất diện tích 300 ',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_7949'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính, ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính, Theo Nghị định 359/2025/NĐ-CP ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_9680'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Tôi là sinh viên, đang ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Tôi là sinh viên, đang làm việc tại một công ty theo ',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_8051'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, nhờ Quý cơ quan, quý Anh/chi g',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_5329'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, Cục Thuế! Tôi là cá nhân kinh ',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_7124'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính: ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính: Chúng tôi là Hộ Kinh Doanh mới',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_4161'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Theo tôi được biết là t',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Theo tôi được biết là tại khoản 4 Điều 13 Nghị định 6',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_5336'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: 1. Công ty Luật TNHH (t',
    qa_19.scenario_description = 'Tình huống thực tế: Title: 1. Công ty Luật TNHH (tổ chức hành nghề luật sư) đáp ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_6483'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ tài chính ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ tài chính Tên doanh nghiệp: Công Ty TNHH',
