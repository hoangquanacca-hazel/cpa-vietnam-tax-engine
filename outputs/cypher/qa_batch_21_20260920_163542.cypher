// ===============================================================================
// BATCH INGESTION: qa_batch_21_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_6499'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Tôi cần hỏi chính sách ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Tôi cần hỏi chính sách thuế như sau 1. Tháng 2/2025 t',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_2581'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Văn phòng đại diện Công',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Văn phòng đại diện Công ty Cổ phần Excel Creates tại ',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_7148'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính. Tôi đang công tác tại Phòng K',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_9497'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Xin được hướng dẫn về chủ thể ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_5418'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ Tài chính.',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ Tài chính. Tôi có một vướng mắc xin được',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_4692'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Theo Khoản 5 Điều 7 Thô',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Theo Khoản 5 Điều 7 Thông tư 219/2013/TT-BTC quy định',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_2460'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính (Vụ Chính sách Thuế) Tiêu đề: ',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_8687'})
ON CREATE SET 
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_4533'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính.Thông qua quá trình nghiên cứu',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_6597'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Đơn vị tôi là trường Ca',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Đơn vị tôi là trường Cao đẳng công lập, thuộc đơn vị ',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_2828'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Căn cứ Điểm a khoản 3 Đ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Căn cứ Điểm a khoản 3 Điều 16 Đơn vị tự bảo đảm từ 70',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_8565'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi: Cục Thuế Việt',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Cục Thuế Việt Nam 1. Thông tin doanh nghiệp',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_9532'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ Tài Ch',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ Tài Chính. CÔNG TY TNHH CUNG ỨNG NH',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_9532'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ Tài Ch',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ Tài Chính. CÔNG TY TNHH CUNG ỨNG NH',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_7151'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính. ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính. Hiện em đang làm việc cho công',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_8985'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Tôi có thực hiện đăng k',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Tôi có thực hiện đăng ký người phụ thuộc là con ruột ',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_9502'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Xin hỏi Bộ Tài chính: V',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Xin hỏi Bộ Tài chính: Về chính sách thuế giá trị gia ',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_7166'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: chồng tôi là người nước',
    qa_18.scenario_description = 'Tình huống thực tế: Title: chồng tôi là người nước ngoài, sau khi kết hôn với tô',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_2447'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính. ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính. Theo Khoản 3, Điều 7 của Nghị ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_4933'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Căn cứ điểm b khoản 3 Đ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Căn cứ điểm b khoản 3 Điều 1 Nghị định số 174/2025/NĐ',
