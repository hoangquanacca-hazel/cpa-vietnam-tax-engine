// ===============================================================================
// BATCH INGESTION: qa_batch_09_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_4281'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Tôi là hộ kinh doanh đa',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Tôi là hộ kinh doanh đang áp dụng phương pháp kê khai',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_1464'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Thực hiện Thông tư số 1',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Thực hiện Thông tư số 12/2025/TT-BTC ngày 19/3/2025 c',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_8246'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Đề nghị Quý Bộ giải đáp',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Đề nghị Quý Bộ giải đáp vấn đề bất cập liên quan đến ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_2198'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính: ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính: Tôi hiện công tác tại Phòng Ki',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_4621'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Cho tôi hỏi, viên chức ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Cho tôi hỏi, viên chức đơn vị sự nghiệp được cử đi th',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_3381'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Chi hỗ trợ tiền ăn cho ',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Chi hỗ trợ tiền ăn cho đại biểu khách mời không trong',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_6034'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính Gửi Bộ Tài chính. ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính Gửi Bộ Tài chính. Tôi là kế toán trường Tiểu học',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_1847'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, nhờ Bộ tài chính hướng dẫn giú',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_7486'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Tôi hiện đang công tác ',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Tôi hiện đang công tác tại một cơ quan quản lý hành c',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_3858'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Thực hiện Thông tư số 1',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Thực hiện Thông tư số 133/2025/TT-BTC hướng dẫn thực ',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_4892'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính đề nghị Bộ Tài chí',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính đề nghị Bộ Tài chính hướng dẫn, làm rõ như sau: ',
...
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Xin chào Ban Biên tập C',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Xin chào Ban Biên tập Cổng thông tin điện tử Bộ Tài c',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_8344'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi: Bộ Tài c',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi: Bộ Tài chính Tôi hiện đang công tác tạ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_5272'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Tôi hiện nay đang công tác tại',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_9265'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Đơn vị tôi là Trường Bồi dưỡng',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_3393'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính thưa Quý Cơ quan C',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính thưa Quý Cơ quan Công ty em là tổ chức đào tạo p',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_1044'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Gia đình tôi có một thử',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Gia đình tôi có một thửa đất trồng cây lâu năm nằm tá',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_9919'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, Gia đình tôi có thửa đất tại T',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_7201'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi BTC, trường tô',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi BTC, trường tôi là đơn vị SNCL nhóm 3, trực ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_3337'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, tôi đang công tác tại trường h',
