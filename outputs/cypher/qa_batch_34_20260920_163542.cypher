// ===============================================================================
// BATCH INGESTION: qa_batch_34_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_2559'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Cho Tôi được hỏi về tờ ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Cho Tôi được hỏi về tờ khai cho thuê tài sản và cách ',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_6983'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính và Cục thuế! Tôi là Kế toán Cô',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_8963'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Tôi đang công tác tại C',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Tôi đang công tác tại Công ty khai thác thuỷ lợi 100%',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_4531'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Xin hỏi từ ngày 01/3/20',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Xin hỏi từ ngày 01/3/2026, hộ kinh doanh có bắt buộc ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_7429'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài Chính ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài Chính Công ty chúng tôi xin trình bà',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_0973'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Mẹ tôi trên 70 tuổi, là',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Mẹ tôi trên 70 tuổi, là thương binh bậc 3/4, đang hưở',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_0143'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Nghị định số 214/2025/N',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Nghị định số 214/2025/NĐ-CP không quy định cụ thể điề',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_2688'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Trong quá trình đánh gi',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Trong quá trình đánh giá E-HSDT gói thầu xây lắp (1 g',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_7994'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Theo quy định trên Hệ t',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Theo quy định trên Hệ thống mạng đấu thầu quốc gia, b',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_6341'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính T',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính Tôi tên là Nguyễn Thị Hải, hiện',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_3065'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Chủ đầu tư là một công ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Chủ đầu tư là một công ty Việt Nam tổ chức mời thầu g',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_1411'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Căn cứ Luật Thuế thu nh',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Căn cứ Luật Thuế thu nhập cá nhân số 04/2007/QH12 ngà',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_1980'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Tôi là Nguyễn Thị Hoa. Theo qu',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_6404'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, tôi đến từ Công ty TNHH Thiết ',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_1794'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Căn cứ quy định tại kho',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Căn cứ quy định tại khoản 7 Điều 1 Nghị định 70/2025/',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_0772'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Hiện nay, doanh nghiệp ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Hiện nay, doanh nghiệp phát sinh vướng mắc liên quan ',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_1099'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi có ph',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi có phát sinh trường hợp điều động n',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_5516'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Tôi tên là LÊ TRẦN BÁ H',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Tôi tên là LÊ TRẦN BÁ HUY, CCCD: 052099000066. Hiện n',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_8594'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính: ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính: Thực hiện sáp nhập, sắp xếp, t',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_0038'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Tôi thực hiện hoạt động',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Tôi thực hiện hoạt động đại lý bán bảo hiểm hưởng hoa',
