// ===============================================================================
// BATCH INGESTION: dispatches_batch_04_20260920_163542
...
MERGE (disp_1:OFFICIAL_DISPATCH {id: 'DISPATCH_0910'})
ON CREATE SET 
    ...
    disp_1.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5090/CT-CS Tiêu đề: V/v thué giå tri gia täng Cơ qu...',
    disp_1.legal_status = 'Active';



MERGE (disp_2:OFFICIAL_DISPATCH {id: 'DISPATCH_4180'})
ON CREATE SET 
    ...
    disp_2.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5093/CT-CS Tiêu đề: V/v Chinh såch thué thu nhép do...',
    disp_2.legal_status = 'Active';



MERGE (disp_3:OFFICIAL_DISPATCH {id: 'DISPATCH_3339'})
ON CREATE SET 
    ...
    disp_3.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5131/CT-CS Tiêu đề: V/v höa don dien tt Cơ quan: No...',
    disp_3.legal_status = 'Active';



MERGE (disp_4:OFFICIAL_DISPATCH {id: 'DISPATCH_4051'})
ON CREATE SET 
    ...
    disp_4.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5134/CT-CS Tiêu đề: V/v höa don KY Cơ quan: None Ng...',
    disp_4.legal_status = 'Active';



MERGE (disp_5:OFFICIAL_DISPATCH {id: 'DISPATCH_4018'})
ON CREATE SET 
    ...
    disp_5.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5149/CT-CS Tiêu đề: V/v thué giå tri gia täng KY Cơ...',
    disp_5.legal_status = 'Active';



MERGE (disp_6:OFFICIAL_DISPATCH {id: 'DISPATCH_1854'})
ON CREATE SET 
    ...
    disp_6.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5150/CT-CS Tiêu đề: V/v thué giåtri giatäng KY Cơ q...',
    disp_6.legal_status = 'Active';



MERGE (disp_7:OFFICIAL_DISPATCH {id: 'DISPATCH_9046'})
ON CREATE SET 
    ...
    disp_7.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5151/CT-CS Tiêu đề: V/v chinh såch thué GTGT. KY Cơ...',
    disp_7.legal_status = 'Active';



MERGE (disp_8:OFFICIAL_DISPATCH {id: 'DISPATCH_7996'})
ON CREATE SET 
    ...
    disp_8.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5160/CT-PC Tiêu đề: V/v trién khai tmrc hi#n Nghi d...',
    disp_8.legal_status = 'Active';



MERGE (disp_9:OFFICIAL_DISPATCH {id: 'DISPATCH_4206'})
ON CREATE SET 
    ...
    disp_9.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5177/CT-CS Tiêu đề: V/v thöng båo hiQu lyc cüa Hi#p...',
    disp_9.legal_status = 'Active';



MERGE (disp_10:OFFICIAL_DISPATCH {id: 'DISPATCH_2283'})
ON CREATE SET 
    ...
    disp_10.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5200/CT-CS Tiêu đề: V/v trå Ibi cong vän sb 20/CV/2...',
    disp_10.legal_status = 'Active';



MERGE (disp_11:OFFICIAL_DISPATCH {id: 'DISPATCH_8988'})
ON CREATE SET 
    ...
    disp_11.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5250/CT-CS Tiêu đề: V/v khoån tibn bd sung Cơ quan:...',
    disp_11.legal_status = 'Active';



MERGE (disp_12:OFFICIAL_DISPATCH {id: 'DISPATCH_9290'})
ON CREATE SET 
    ...
    disp_12.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5269/CT-CS Tiêu đề: V/v thué giå tri gia täng höa d...',
    disp_12.legal_status = 'Active';



MERGE (disp_13:OFFICIAL_DISPATCH {id: 'DISPATCH_9279'})
ON CREATE SET 
    ...
    disp_13.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5280/CT-NVT Tiêu đề: V/v hoån thué GTGT tråbng hqp•...',
    disp_13.legal_status = 'Active';



MERGE (disp_14:OFFICIAL_DISPATCH {id: 'DISPATCH_7568'})
ON CREATE SET 
    ...
    disp_14.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5287/CT-CS Tiêu đề: V/v chinh såch thué giå tri gia...',
    disp_14.legal_status = 'Active';



MERGE (disp_15:OFFICIAL_DISPATCH {id: 'DISPATCH_5410'})
ON CREATE SET 
    ...
    disp_15.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5288/CT-CS Tiêu đề: V/v Chinh såch thué giå tri gia...',
    disp_15.legal_status = 'Active';



MERGE (disp_16:OFFICIAL_DISPATCH {id: 'DISPATCH_1319'})
ON CREATE SET 
    ...
    disp_16.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5318/CT-CS Tiêu đề: V/v thué giå tri gia täng Cơ qu...',
    disp_16.legal_status = 'Active';



MERGE (disp_17:OFFICIAL_DISPATCH {id: 'DISPATCH_9121'})
ON CREATE SET 
    ...
    disp_17.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5319/CT-CS Tiêu đề: V/v chinh såch thué Cơ quan: No...',
    disp_17.legal_status = 'Active';



MERGE (disp_18:OFFICIAL_DISPATCH {id: 'DISPATCH_1531'})
ON CREATE SET 
    ...
    disp_18.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5321/CT-CS Tiêu đề: None Cơ quan: None Ngày: None F...',
    disp_18.legal_status = 'Active';



MERGE (disp_19:OFFICIAL_DISPATCH {id: 'DISPATCH_9173'})
ON CREATE SET 
    ...
    disp_19.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5334/CT-CS Tiêu đề: V/v thué giå tri gia täng KY Cơ...',
    disp_19.legal_status = 'Active';



MERGE (disp_20:OFFICIAL_DISPATCH {id: 'DISPATCH_2131'})
ON CREATE SET 
    ...
    disp_20.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 5344/CT-CS Tiêu đề: V/v chinh såch thué Cơ quan: No...',
