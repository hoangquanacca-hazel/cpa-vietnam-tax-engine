// ===============================================================================
// BATCH INGESTION: qa_batch_01_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_6952'})
ON CREATE SET 
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_9918'})
ON CREATE SET 
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_5738'})
ON CREATE SET 
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_8983'})
ON CREATE SET 
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_1730'})
ON CREATE SET 
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_4485'})
ON CREATE SET 
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_6732'})
ON CREATE SET 
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_5719'})
ON CREATE SET 
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_1978'})
ON CREATE SET 
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_6786'})
ON CREATE SET 
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_2382'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính! ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Tôi có thắc mắc nội dung về th',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_3720'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Doanh nghiệp chúng tôi ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Doanh nghiệp chúng tôi có một vướng mắc kính mong Bộ ',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_8742'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Thắc mắc về chính sách ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Thắc mắc về chính sách thuế GTGT đối với mặt hàng mỡ ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_0213'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ Tài ch',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ Tài chính, theo tôi được biết Bộ Tài',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_6394'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Hỏi: Công ty tôi được g',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Hỏi: Công ty tôi được giao đất thực hiện dự án năm 20',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_7068'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Câu hỏi liên quan đến v',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Câu hỏi liên quan đến việc áp dụng quy định về xuất n',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_5622'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ tài ch',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ tài chính Tôi có một số vướng mắc, k',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_4187'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Trong quá trình thực hiện dự t',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_3936'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, xin kính nhờ Quý cơ quan giải ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_1743'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Nội dung: Chính sách th',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Nội dung: Chính sách thuế GTGT đối với hàng hóa chưa ',
