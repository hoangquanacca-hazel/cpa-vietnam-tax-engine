// ===============================================================================
// BATCH INGESTION: dispatches_batch_03_20260920_163542
...
MERGE (disp_1:OFFICIAL_DISPATCH {id: 'DISPATCH_1697'})
ON CREATE SET 
    ...
    disp_1.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4623/CT-CS Tiêu đề: V/v Chinh såch thué giå tri gia...',
    disp_1.legal_status = 'Active';



MERGE (disp_2:OFFICIAL_DISPATCH {id: 'DISPATCH_5194'})
ON CREATE SET 
    ...
    disp_2.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4631/CT-CS Tiêu đề: V/v Chinh såch thué Cơ quan: No...',
    disp_2.legal_status = 'Active';



MERGE (disp_3:OFFICIAL_DISPATCH {id: 'DISPATCH_7545'})
ON CREATE SET 
    ...
    disp_3.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4637/CT-CS Tiêu đề: V/v xt l! vu6ng mic lién quan d...',
    disp_3.legal_status = 'Active';



MERGE (disp_4:OFFICIAL_DISPATCH {id: 'DISPATCH_2819'})
ON CREATE SET 
    ...
    disp_4.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4643/CT-CS Tiêu đề: V/v trå Ibi Chinh såch thug TNC...',
    disp_4.legal_status = 'Active';



MERGE (disp_5:OFFICIAL_DISPATCH {id: 'DISPATCH_4538'})
ON CREATE SET 
    ...
    disp_5.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4644/CT-CS Tiêu đề: V/v trå Ibi dan phån ånh kién n...',
    disp_5.legal_status = 'Active';



MERGE (disp_6:OFFICIAL_DISPATCH {id: 'DISPATCH_3085'})
ON CREATE SET 
    ...
    disp_6.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4657/TCT-CS Tiêu đề: V/v tih thué dåt. Cơ quan: Non...',
    disp_6.legal_status = 'Active';



MERGE (disp_7:OFFICIAL_DISPATCH {id: 'DISPATCH_1878'})
ON CREATE SET 
    ...
    disp_7.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4671/CT-CS Tiêu đề: V/v hu6ng dÄn k} tinh thué. Cơ...',
    disp_7.legal_status = 'Active';



MERGE (disp_8:OFFICIAL_DISPATCH {id: 'DISPATCH_7367'})
ON CREATE SET 
    ...
    disp_8.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4673/CT-CS Tiêu đề: V/v chinh såch thué Cơ quan: No...',
    disp_8.legal_status = 'Active';



MERGE (disp_9:OFFICIAL_DISPATCH {id: 'DISPATCH_3286'})
ON CREATE SET 
    ...
    disp_9.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4675/CT-CS Tiêu đề: V/v thué giå tri gia täng CONG ...',
    disp_9.legal_status = 'Active';



MERGE (disp_10:OFFICIAL_DISPATCH {id: 'DISPATCH_5286'})
ON CREATE SET 
    ...
    disp_10.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4676/CT-CS Tiêu đề: V/v Chinh såch thué Cơ quan: No...',
    disp_10.legal_status = 'Active';



MERGE (disp_11:OFFICIAL_DISPATCH {id: 'DISPATCH_3411'})
ON CREATE SET 
    ...
    disp_11.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4678/CT-CS Tiêu đề: V/v Sü dvng höa don Cơ quan: No...',
    disp_11.legal_status = 'Active';



MERGE (disp_12:OFFICIAL_DISPATCH {id: 'DISPATCH_8965'})
ON CREATE SET 
    ...
    disp_12.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4683/CT-CS Tiêu đề: V/v trä Ibi cang vän sé 6130//L...',
    disp_12.legal_status = 'Active';



MERGE (disp_13:OFFICIAL_DISPATCH {id: 'DISPATCH_2174'})
ON CREATE SET 
    ...
    disp_13.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4684/CT-CS Tiêu đề: V/v chfnh såch thué Cơ quan: No...',
    disp_13.legal_status = 'Active';



MERGE (disp_14:OFFICIAL_DISPATCH {id: 'DISPATCH_1817'})
ON CREATE SET 
    ...
    disp_14.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4697/CT-CS Tiêu đề: V/v gi6i thiéu mét sb diém m6i ...',
    disp_14.legal_status = 'Active';



MERGE (disp_15:OFFICIAL_DISPATCH {id: 'DISPATCH_9459'})
ON CREATE SET 
    ...
    disp_15.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4736/CT-CS Tiêu đề: None Cơ quan: None Ngày: None F...',
    disp_15.legal_status = 'Active';



MERGE (disp_16:OFFICIAL_DISPATCH {id: 'DISPATCH_1078'})
ON CREATE SET 
    ...
    disp_16.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4782/CT-CS Tiêu đề: None Cơ quan: None Ngày: None F...',
    disp_16.legal_status = 'Active';



MERGE (disp_17:OFFICIAL_DISPATCH {id: 'DISPATCH_7896'})
ON CREATE SET 
    ...
    disp_17.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4812/CT-QLTT Tiêu đề: V/v gi6i sb diém m6i vå trién...',
    disp_17.legal_status = 'Active';



MERGE (disp_18:OFFICIAL_DISPATCH {id: 'DISPATCH_3620'})
ON CREATE SET 
    ...
    disp_18.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4814/CT-CS Tiêu đề: V/v h6a do-n Cơ quan: None Ngày...',
    disp_18.legal_status = 'Active';



MERGE (disp_19:OFFICIAL_DISPATCH {id: 'DISPATCH_2051'})
ON CREATE SET 
    ...
    disp_19.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4831/CT-CS Tiêu đề: None Cơ quan: Cục Thuế Ngày: No...',
    disp_19.legal_status = 'Active';



MERGE (disp_20:OFFICIAL_DISPATCH {id: 'DISPATCH_7322'})
ON CREATE SET 
    ...
    disp_20.summary = 'Hướng dẫn thuế theo nội dung: Số hiệu: 4937/CT-NVT Tiêu đề: None Cơ quan: Cục Thuế Ngày: N...',
