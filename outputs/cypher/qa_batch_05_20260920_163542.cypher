// ===============================================================================
// BATCH INGESTION: qa_batch_05_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_6203'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi Quý cơ quan Th',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi Quý cơ quan Thuế, Tôi xin phép nhờ Quý cơ qu',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_4390'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Thưa quý Bộ! Ngày 29/12',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Thưa quý Bộ! Ngày 29/12/2025 Chính phủ ban hành Nghị ',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_0759'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính!',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính! Tôi hiện đang nghiên cứu thực',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_7760'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Tôi tên là Đào Thị Mai. Tôi xi',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_1888'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Ngày 01/06/2026, Chính ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Ngày 01/06/2026, Chính phủ ban hành Nghị định số 193/',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_2218'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính/C',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính/Cơ quan Thuế, Tôi xin phép được',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_8043'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Gia đình tôi thuộc diện',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Gia đình tôi thuộc diện thân nhân liệt sĩ (gồm mẹ tôi',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_5554'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính. ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính. Trên cổng thông tin điện tử củ',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_8055'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Đề nghị Bộ Tài chính',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Đề nghị Bộ Tài chính hướng dẫn việc kê khai phí bả',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_8446'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Theo khoản 1 Điều 10 Th',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Theo khoản 1 Điều 10 Thông tư 91/2026/TT-BTC có hiệu ',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_9283'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Tôi là chủ sở hữu đồng ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Tôi là chủ sở hữu đồng thời là Giám đốc của một công ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_5342'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: I. TÓM TẮT SỰ VIỆC 1. Đ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: I. TÓM TẮT SỰ VIỆC 1. Đầu năm 2025, gia đình tôi xây ',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_1345'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính, ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính, Theo tôi được biết, Bộ Tài chí',
...
ON CREATE SET 
    ...
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính! Tôi hiện đang làm việc tại Sở',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_0869'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính! ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính! Tôi hiện đang công tác tại Tru',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_8123'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi Cổng Thông tin',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cổng Thông tin điện tử Chính phủ, Tôi công t',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_0150'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Vào năm 2008 tôi có nhận chuyể',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_8938'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính chào anh/chị, Em c',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính chào anh/chị, Em có một thắc mắc liên quan đến v',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_2527'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Quý cơ quan, C',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Quý cơ quan, Công ty TNHH Bông Bông Group (M',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_0566'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Tôi có thắc mắc liên quan đến ',
