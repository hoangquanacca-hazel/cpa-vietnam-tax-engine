// ===============================================================================
// BATCH INGESTION: qa_batch_03_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_1407'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Theo Nghị định số 20/20',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Theo Nghị định số 20/2026/NĐ-CP, quy định miễn thuế t',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_3298'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Hỏi: Kinh gửi: CỤC THUẾ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kinh gửi: CỤC THUẾ Hiện tại, tôi đang giải quyết',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_7062'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Công ty Vận tải Thiện T',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Công ty Vận tải Thiện Trí có trụ sở chính tại tỉnh Kh',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_4107'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: CÂU HỎI VỀ VIỆC KHẤU TR',
    qa_4.scenario_description = 'Tình huống thực tế: Title: CÂU HỎI VỀ VIỆC KHẤU TRỪ THUẾ TNCN ĐỐI VỚI KHOẢN THU ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_4305'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: THỜI ĐIỂM XÁC ĐỊNH THU ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: THỜI ĐIỂM XÁC ĐỊNH THU NHẬP TÍNH THUẾ KHÔNG THỂ ĐÁNH ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_4999'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Ngày 29/07/2026: Công t',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Ngày 29/07/2026: Công ty xuất hóa đơn điện tử khởi tạ',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_1648'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Hiện nay, đơn vị đang t',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Hiện nay, đơn vị đang tham mưu UBND xã triển khai thự',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_0063'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Xin quý cơ quan giải đá',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Xin quý cơ quan giải đáp giúp công ty vấn đề sau ạ: C',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_1566'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Căn cứ pháp lý: Luật Th',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Căn cứ pháp lý: Luật Thuế thu nhập cá nhân số 109/202',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_5919'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ tài chính: ',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ tài chính: Trong hoạt động sản xuất kinh ',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_5718'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Sau đây tôi xin phép được hỏi ',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_4703'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi kính ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi kính đề nghị Bộ Tài chính hướng dẫn',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_4804'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Tôi xin giải đáp nội',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Tôi xin giải đáp nội dung sau: 1. Về thời điểm lập',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_5330'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chi',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Tôi xin kính nhờ Quý cơ ',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_1125'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Ngày 20/06/2026: Gia đì',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Ngày 20/06/2026: Gia đình tôi ký Văn bản phân chia di',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_8305'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Tôi muốn hỏi về quy địn',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Tôi muốn hỏi về quy định khấu trừ thuế TNCN 10% đối v',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_4460'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi xin p',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi xin phép được gửi tới Quý cơ quan m',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_3550'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi: Quý Cơ quan, ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Quý Cơ quan, tôi có vài thắc mắc về Quy địn',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_8230'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Tôi hiện đang vận hành ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Tôi hiện đang vận hành hoạt động tiếp thị liên kết (A',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_4558'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính. ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính. Căn cứ tại khoản 2 Điều 50 Ngh',
