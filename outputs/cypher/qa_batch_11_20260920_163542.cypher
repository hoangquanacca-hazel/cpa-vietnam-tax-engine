// ===============================================================================
// BATCH INGESTION: qa_batch_11_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_8771'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kinh gửi Bộ tài chính. ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kinh gửi Bộ tài chính. Tôi xin hỏi 1 vấn đề như sau: ',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_8908'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi Cơ quan thuế: ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi Cơ quan thuế: Theo nghị định số 253/2026/ND-',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_7859'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính,',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính, Tôi có câu hỏi kính mong Bộ t',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_0116'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi bộ tài chính. ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi bộ tài chính. Theo quy định tại Thông tư số ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_3869'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi: Ban Biên tập ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Ban Biên tập Cổng thông tin điện tử - Bộ Tà',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_1380'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Tôi xin hỏi về chính sá',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Tôi xin hỏi về chính sách miễn, giảm tiền sử dụng đất',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_9972'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Hiện nay tôi đang công ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Hiện nay tôi đang công tác tại Ban Quản lý dự án xã (',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_1485'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Kính chào Bộ Tài chính,',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Kính chào Bộ Tài chính, công ty tôi là doanh nghiệp n',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_5305'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính đề nghị BTC xây dự',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính đề nghị BTC xây dựng ban hành thủ tục hoàn tiền ',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_4457'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính !',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính ! Đơn vị chúng tôi là đơn vị sự',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_5529'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kiến nghị hướng dẫn thủ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kiến nghị hướng dẫn thủ tục ủy quyền nhận chế độ BHXH',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_4933'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Tôi có câu hỏi nhờ Quý Bộ giải',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_0601'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Tôi tên Phạm Thu Hà, hiện đang',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_4338'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Tôi có hai người bạn qu',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Tôi có hai người bạn quốc tịch Đài Loan (Trung Quốc).',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_6986'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Doanh nghiệp của tôi đa',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Doanh nghiệp của tôi đang làm hiện là doanh nghiệp ni',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_2762'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, kính nhờ Bộ trả lời câu hỏi nà',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_2963'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Các gói thầu đo đạc bản',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Các gói thầu đo đạc bản đồ địa chính, đăng ký đất đai',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_3729'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Đơn vị chúng tôi hiện đang tri',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_9343'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ Tài Chính ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ Tài Chính , tôi hiện là chuyên viên quản',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_6197'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Hiện nay, theo quy định',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Hiện nay, theo quy định tại Thông tư số 101/2020/TT-B',
