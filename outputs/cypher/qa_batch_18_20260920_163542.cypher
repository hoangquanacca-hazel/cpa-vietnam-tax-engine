// ===============================================================================
// BATCH INGESTION: qa_batch_18_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_2427'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ Tài chính.',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ Tài chính. Tôi có một vướng mắc xin được',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_0190'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ Tài chính.',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ Tài chính. Tôi hiện đan công tác tại Ban',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_7189'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Chúng tôi có nhập khẩu mặt hàn',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_7661'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính. ',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính. Tôi đại diện Công ty Cổ phần Đ',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_6738'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, kính nhờ bộ tài chính hướng dẫ',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_2724'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Địa phương tôi đang dự ',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Địa phương tôi đang dự kiến đầu tư xây dựng một số dự',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_2786'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính ',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính Nội dung hỏi về việc xác định ',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_2414'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Do thiếu biên chế, đơn ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Do thiếu biên chế, đơn vị tôi (cơ quan quản lý nhà nư',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_6815'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Tại điểm b, khoản 2, đi',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Tại điểm b, khoản 2, điều 5Theo Thông tư 40/2017/TT-B',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_4680'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Hỏi: Kính gửi Bộ Tài Ch',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Hỏi: Kính gửi Bộ Tài Chính về việc áp dụng Thông tư 1',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_5663'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Câu hỏi: Theo khoản 7, ',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Câu hỏi: Theo khoản 7, Điều 1 của Thông tư số 12/2025',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_0855'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Theo điểm b, khoản 2 Đi',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Theo điểm b, khoản 2 Điều 5 của Thông tư 40/2017/TT-B',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_3236'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Luật Đê điều quy định l',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Luật Đê điều quy định lực lượng chuyên trách quản lý ',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_3638'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính chào Bộ Tài Chính,',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính chào Bộ Tài Chính, Tôi hiện đang có câu hỏi vướn',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_1405'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Ngày 03/06/2025 Thuế tỉ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Ngày 03/06/2025 Thuế tỉnh Phú Thọ có ban hành Công vă',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_1925'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Hỏi: Công ty của chúng ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Hỏi: Công ty của chúng tôi đã được chuyển đổi từ doan',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_4856'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, Chúng tôi là Công ty Cổ phần A',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_2632'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Tôi đang công tác tại m',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Tôi đang công tác tại một cơ quan nhà nước, hưởng lươ',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_6056'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: 1. Về việc chi thù lao ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: 1. Về việc chi thù lao báo cáo viên là công chức tại ',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_2851'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Trước đây, có nội dung ',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Trước đây, có nội dung hỏi liên quan đến chế độ công ',
