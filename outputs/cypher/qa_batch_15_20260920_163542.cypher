// ===============================================================================
// BATCH INGESTION: qa_batch_15_20260920_163542
...
MERGE (qa_1:PRACTICAL_QA {id: 'QA_TAX_VAT_8431'})
ON CREATE SET 
    qa_1.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_1.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, Tôi đang tìm hiểu việc áp dụng',
...
MERGE (qa_2:PRACTICAL_QA {id: 'QA_TAX_VAT_3674'})
ON CREATE SET 
    qa_2.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_2.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, tôi hiện đang công tác tại Ban',
...
MERGE (qa_3:PRACTICAL_QA {id: 'QA_TAX_VAT_2889'})
ON CREATE SET 
    qa_3.title = 'Giải đáp thắc mắc về Title: Kính gửi: Ủy ban Chứng ',
    qa_3.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Ủy ban Chứng khoán Nhà nước - Bộ Tài chính ',
...
MERGE (qa_4:PRACTICAL_QA {id: 'QA_TAX_VAT_3539'})
ON CREATE SET 
    qa_4.title = 'Giải đáp thắc mắc về Title: Kính gửi: Bộ Tài chính.',
    qa_4.scenario_description = 'Tình huống thực tế: Title: Kính gửi: Bộ Tài chính. Tôi muốn hỏi về trường hợp Do',
...
MERGE (qa_5:PRACTICAL_QA {id: 'QA_TAX_VAT_2581'})
ON CREATE SET 
    qa_5.title = 'Giải đáp thắc mắc về Title: Tôi hiện đang công tác ',
    qa_5.scenario_description = 'Tình huống thực tế: Title: Tôi hiện đang công tác tại Trung tâm Xúc tiến Du lịch',
...
MERGE (qa_6:PRACTICAL_QA {id: 'QA_TAX_VAT_7452'})
ON CREATE SET 
    qa_6.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính v',
    qa_6.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính và Tổng cục Thuế, Hiện nay, the',
...
MERGE (qa_7:PRACTICAL_QA {id: 'QA_TAX_VAT_6373'})
ON CREATE SET 
    qa_7.title = 'Giải đáp thắc mắc về Title: Kính thưa bộ tài chính.',
    qa_7.scenario_description = 'Tình huống thực tế: Title: Kính thưa bộ tài chính. Tôi là hộ kinh doanh Tống Đức',
...
MERGE (qa_8:PRACTICAL_QA {id: 'QA_TAX_VAT_1164'})
ON CREATE SET 
    qa_8.title = 'Giải đáp thắc mắc về Title: Công ty chúng tôi hoạt ',
    qa_8.scenario_description = 'Tình huống thực tế: Title: Công ty chúng tôi hoạt động trong lĩnh vực đại lý dịc',
...
MERGE (qa_9:PRACTICAL_QA {id: 'QA_TAX_VAT_0633'})
ON CREATE SET 
    qa_9.title = 'Giải đáp thắc mắc về Title: Kính gửi Quý cơ quan, t',
    qa_9.scenario_description = 'Tình huống thực tế: Title: Kính gửi Quý cơ quan, tôi có câu hỏi như sau: công ty',
...
MERGE (qa_10:PRACTICAL_QA {id: 'QA_TAX_VAT_5523'})
ON CREATE SET 
    qa_10.title = 'Giải đáp thắc mắc về Title: Kính thưa Bộ tài chính,',
    qa_10.scenario_description = 'Tình huống thực tế: Title: Kính thưa Bộ tài chính, Công ty chúng tôi hoạt động t',
...
MERGE (qa_11:PRACTICAL_QA {id: 'QA_TAX_VAT_5379'})
ON CREATE SET 
    qa_11.title = 'Giải đáp thắc mắc về Title: Kính gửi : Bộ Tài chính',
    qa_11.scenario_description = 'Tình huống thực tế: Title: Kính gửi : Bộ Tài chính Công ty tôi chuyên buôn bán t',
...
MERGE (qa_12:PRACTICAL_QA {id: 'QA_TAX_VAT_4221'})
ON CREATE SET 
    qa_12.title = 'Giải đáp thắc mắc về Title: Bố chồng tôi là cụ Hoàn',
    qa_12.scenario_description = 'Tình huống thực tế: Title: Bố chồng tôi là cụ Hoàng Thế Dũng, được công nhận là ',
...
MERGE (qa_13:PRACTICAL_QA {id: 'QA_TAX_VAT_2062'})
ON CREATE SET 
    qa_13.title = 'Giải đáp thắc mắc về Title: Kính gửi! Kính gửi Chín',
    qa_13.scenario_description = 'Tình huống thực tế: Title: Kính gửi! Kính gửi Chính phủ và Bộ Tài chính, trong t',
...
MERGE (qa_14:PRACTICAL_QA {id: 'QA_TAX_VAT_9486'})
ON CREATE SET 
    qa_14.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính. ',
    qa_14.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính. Công ty tôi (thành lập tại Việ',
...
MERGE (qa_15:PRACTICAL_QA {id: 'QA_TAX_VAT_9899'})
ON CREATE SET 
    qa_15.title = 'Giải đáp thắc mắc về Title: Tôi đề nghị được hướng ',
    qa_15.scenario_description = 'Tình huống thực tế: Title: Tôi đề nghị được hướng dẫn về việc lập và thực hiện n',
...
MERGE (qa_16:PRACTICAL_QA {id: 'QA_TAX_VAT_1045'})
ON CREATE SET 
    qa_16.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính! ',
    qa_16.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính! Ngày 10/12/2025 Quốc hội khóa ',
...
MERGE (qa_17:PRACTICAL_QA {id: 'QA_TAX_VAT_5701'})
ON CREATE SET 
    qa_17.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chính, ',
    qa_17.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính, tôi là chủ Hộ Kinh Doanh Hoàng',
...
MERGE (qa_18:PRACTICAL_QA {id: 'QA_TAX_VAT_4610'})
ON CREATE SET 
    qa_18.title = 'Giải đáp thắc mắc về Title: Công ty TNHH TSTB Consu',
    qa_18.scenario_description = 'Tình huống thực tế: Title: Công ty TNHH TSTB Consulting đang hỗ trợ doanh nghiệp',
...
MERGE (qa_19:PRACTICAL_QA {id: 'QA_TAX_VAT_4752'})
ON CREATE SET 
    qa_19.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài chính, ',
    qa_19.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài chính, tôi đang là kế toán hạng 3 tại',
...
MERGE (qa_20:PRACTICAL_QA {id: 'QA_TAX_VAT_3852'})
ON CREATE SET 
    qa_20.title = 'Giải đáp thắc mắc về Title: Kính gửi Bộ Tài Chi',
    qa_20.scenario_description = 'Tình huống thực tế: Title: Kính gửi Bộ Tài Chính! Xin trả lời giúp tôi c',
